local crow_cv = function (self, x, y)
	...
	--local attack = (self:listen( self.x + 4, self.y ) or 0) * .01
  local attack = util.linexp(0, 35, 0.00, 5.00, self:listen( self.x + 4, self.y ) or 0)
  --local release = (self:listen( self.x + 5, self.y ) or 1) * .001
	local release = util.explin(0, 35, 0.00, 5.00, self:listen( self.x + 5, self.y ) or 1)
  ...
  print('Pre Level')
  print(self:listen( self.x + 6, self.y ))
  print('Pre Release')
  print(self:listen( self.x + 5, self.y ))
  print('Post Attack')
  print(attack)
  print('Post Level')
  print(level)
